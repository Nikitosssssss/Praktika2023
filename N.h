...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->richTextBox2->Text = L"Реагирует с металлами (при обычных условиях только с литием, для реакции с другим"
				L"и металлами необхожимо нагревание):";
			// 
			// label2
			// 
			...
			this->richTextBox3->Text = L"Реагирует с водородом при высоких температуре и давлении в присутствии катализато"
				L"ра - железа.";
			// 
			// pictureBox6
			// 
			...
			this->richTextBox5->Text = L"Проявляет восстановительные свойства в реакциях с кислородом и фтором. Реакции пр"
				L"отекают при температуре выше 1000 C.";
			// 
			// pictureBox8
			// 
			...
			this->richTextBox4->Text = L"Может реагировать с неметаллами при нагревании, образуя нитриды:";
			// 
			// N
			// 
