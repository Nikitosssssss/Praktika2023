...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->richTextBox2->Text = L"Взаимодействует почти со всеми металлами, образуя хлориды(в этих соединениях хлор"
				L" одновалентен):";
			// 
			// label2
			// 
			...
			this->richTextBox3->Text = L"Взаимодействует с неметаллами:";
			// 
			// pictureBox1
			// 
			...
			this->richTextBox5->Text = L"Вытесняет неметаллы из их соединений:";
			// 
			// pictureBox8
			// 
			...
			this->richTextBox6->Text = L"Взаимодействует с щелочами:";
			// 
			// pictureBox10
			// 
			...
			this->richTextBox7->Text = L"Получение хлора:";
			// 
			// pictureBox11
			// 
